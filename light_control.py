...
class light_control:
    ...
    def extract_and_load_dataset(self, zip_path, extract_dir="dataset"):
        ...
        for person_dir in os.listdir(dataset_root):
            ...
            for gesture_dir in os.listdir(person_path):
                ...
                if gesture_dir.lower() == "02_l":
                    label = "l"
                elif gesture_dir.lower() == "03_fist":
                    label = "fist"
                else:
                    continue
    ...
    def detect_gestures(self):
        ...
        is_on = most_common == "l"
        is_off = most_common == "fist"

        if is_on:
            cv2.putText(img, "Lamba Acildi!", (10, 30), cv2.FONT_HERSHEY_PLAIN, 3, (0, 255, 0), 3)
            cv2.rectangle(img, (0, 0), (w, h), (0, 255, 0), 2)
        elif is_off:
            cv2.putText(img, "Lamba Kapandi!", (10, 30), cv2.FONT_HERSHEY_PLAIN, 3, (0, 0, 255), 3)
            cv2.rectangle(img, (0, 0), (w, h), (0, 0, 255), 2)

        return is_on, is_off, img
